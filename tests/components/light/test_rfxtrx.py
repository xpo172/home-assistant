...
class TestLightRfxtrx(unittest.TestCase):
    ...
    def test_light_transition(self):
        ...
        self.assertTrue(entity.transition_timer.is_alive)
        time.sleep(0.5)
        self.assertTrue(entity.is_on)
        self.assertEqual(entity.brightness, 255)

        entity.turn_on(brightness=10, transition=0.5)
        time.sleep(0.5)
        self.assertTrue(entity.is_on)
        self.assertEqual(entity.brightness, 10)
        ...
        entity.turn_on(brightness=11, transition=1000)
        time.sleep(0.2)
        self.assertTrue(entity.is_on)
        ...
        self.assertFalse(entity.is_on)
        self.assertEqual(entity.brightness, 0)
        self.assertTrue(entity.transition_timer.finished)
